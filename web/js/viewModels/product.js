 ...
 function(oj, ko, $) {
    ...
    function DiscoverViewModel() {
      ...
      self.connected = function() {
        // Implement if needed
        $.getJSON("https://lvehgh9rrmbgcid-db201911041446.adb.ap-tokyo-1.oraclecloudapps.com/ords/kyle/atp/productstop",
        function(data)
        {
          console.log(data.items);
          let ds = {"attr": {"id": "coffee",
                "name": "Blended Beverages"
                }
            };

          ds.children = data.items.map(e => {
            return {"attr": {"id": "123",
                        "name": e.product_name + ', sold (' + e.count + ')',
                        "img": "americano.png"
                    }
            };
          })
          
          self.products(new oj.JsonTreeDataSource(ds));
